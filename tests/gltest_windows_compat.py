"""Test-only Windows shims for genlayer-test 0.29.2 and GLSim."""
...
def install_windows_direct_compatibility() -> None:
    ...
    if getattr(loader, "_rubric_lock_windows_compat", False):
        return
...
def install_glsim_direct_compatibility() -> None:
    ...
    if getattr(engine_module, "_rubric_lock_direct_compat", False):
        return
    ...
    engine_module._rubric_lock_direct_compat = True
